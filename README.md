...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-o71ns5e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-o71ns5e.containers.anotherwebservice.com/
...
```
git clone git@github.com:rrafaa1312/container-o71ns5e.git
cd container-o71ns5e
```
...
```
docker attach container-o71ns5e
```
